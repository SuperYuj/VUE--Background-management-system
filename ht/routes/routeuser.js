...
// 无图片添加用户信息请求
routerdemo.post('/add2', control.addsub2);
// 删除用户信息
...
// 上传图片接口
routerdemo.post('/uploadFile', upload.single('head'), function (req, res) {
    console.log('图片上传>>' + req.session.headurl);
    res.send(`${req.session.headurl}`);
});
// 下载文件

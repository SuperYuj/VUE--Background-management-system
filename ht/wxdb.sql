...
INSERT INTO `productlist` VALUES (13, '333', '/upload1/head-1554885171966.png', '3333', 3333.00);
INSERT INTO `productlist` VALUES (14, '231', '/upload1/head-1554885222196.png', '3123', 2313.00);
...
CREATE TABLE `user`  (
  ...
  `headurl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '头像',
  PRIMARY KEY (`id`) USING BTREE
